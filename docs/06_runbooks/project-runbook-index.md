...
| Summarizer Engine | Summary Bus producer | Event summaries, session summaries, document summaries, chunk-set summaries, manifests | See repo runbook | See repo runbook | See run record contract | Link to repo runbook | Summary Bus contract, Summary Request Seam, Manifests and integrity, Run record contract, Error taxonomy, Integration seams |
